                ...
                <form action="{{ route('upload-slide') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive p-1">
                        <table id="" class="table table-bordered dt-responsive nowrap text-center" style="width: 100%;">
                            <tr><td><img src="{{ asset('/') }}admin/assets/images/favicon.png" alt="" id="slide_show" style="max-height: 244px"></td></tr>
                            <tr>
                                <td>
                                    ...
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9 text-left">
                                            <div class="form-check col-form-label">
                                                <input class="form-check-input" type="radio" name="slide_status" value="1">
                                                <label class="form-check-label">Published</label>
                                            </div>
                                            <div class="form-check col-form-label">
                                                <input class="form-check-input" type="radio" name="slide_status" value="2">
