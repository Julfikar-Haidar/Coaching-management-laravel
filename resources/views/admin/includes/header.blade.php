...
<body>
   ...
   @if (isset($header))
    ...
    <section>
        <div class="col-sm-12 text-center header pb-1">
            ...
            <h5 class="menu-bg p-2 pl-3 pr-3 mb-1">{{$header->owner_dept}}</h5>
            <p class="font-weight-bold mb-0">{{$header->address}}</p>
            <p class="font-weight-bold mb-0">{{$header->owner_mobile}}</p>
        </div>
    </section>
    @else
     <section>
   ...
   @endif
    ...
    <!--User Avatar Start-->
    <img class="avatar" src="@if (Auth::user()->avatar){!! asset('admin/avatar/'.$users->avatar) !!}@else{{ asset('/') }}admin/assets//images/avatar.png
        {{-- expr --}}
    @endif" alt="Avatar">
    <!--User Avatar Start-->
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('add-header-footer') }}" class="dropdown-item">Add Header footer form</a></li>
                                @if (isset($header))
                                    <li><a href="{{ route('manage-header-footer',$header->id) }}" class="dropdown-item">Manage Header footer form</a></li>
                                @endif
                            </ul>
                        </li>
                        ...
                        <li class="dropdown-submenu">
                            ...
                            @endif
                                ...
                                <li><a href="{{ route('users-profile',['userId'=>Auth::user()->id]) }}" class="dropdown-item">User Profile</a></li> 
                            </ul>
                        </li>
