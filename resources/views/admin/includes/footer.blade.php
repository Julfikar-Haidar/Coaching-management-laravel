...
<footer class="container-fluid">
    <div class="row footer">
        <div class="col-12">
            <p class="pt-2 mb-2 text-center">Copyright &copy; <a class="footer-link" href="">@if (isset($header)) {{$header->copyright}} @else Owner @endif </a> || Developed  by:
                <a class="footer-link" href="#">JFIT Solution</a></p>
        </div>
    </div>
</footer>
<!--Footer End-->
